...
assert_file "$PROJECT/.agentic-dev-system/skills/start-work/SKILL.md"
assert_file "$PROJECT/.agentic-dev-system/skills/tdd-work/SKILL.md"
assert_file "$PROJECT/.agentic-dev-system/skills/review-feedback/SKILL.md"
assert_file "$PROJECT/.agentic-dev-system/skills/docs-review/SKILL.md"
assert_file "$PROJECT/.agentic-dev-system/registry.json"
...
assert_file "$SELECTIVE/.agentic-dev-system/registry.json"
