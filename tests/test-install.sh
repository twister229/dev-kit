...
assert_file "$PROJECT/.agents/skills/start-work/SKILL.md"
assert_file "$PROJECT/.agents/skills/onboard-project/SKILL.md"
assert_file "$PROJECT/.agents/registry.json"
...
assert_not_dir "$SELECTIVE/.agents"

CODEX_ONLY="$TEST_TMPDIR/codex-only"
mkdir -p "$CODEX_ONLY"
"$ROOT/scripts/install.sh" "$CODEX_ONLY" --codex
assert_file "$CODEX_ONLY/AGENTS.md"
assert_file "$CODEX_ONLY/.agents/skills/start-work/SKILL.md"
assert_file "$CODEX_ONLY/.agents/skills/onboard-project/SKILL.md"
assert_file "$CODEX_ONLY/.agents/registry.json"
assert_not_file "$CODEX_ONLY/CLAUDE.md"
assert_not_file "$CODEX_ONLY/.github/copilot-instructions.md"
assert_not_dir "$CODEX_ONLY/.claude"
assert_not_dir "$CODEX_ONLY/.opencode"
